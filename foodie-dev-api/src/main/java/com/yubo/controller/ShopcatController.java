...
import com.yubo.pojo.bo.ShopcartBO;
...
public class ShopcatController {
    ...
    private String carIndex = "FOODIE_SHOPCART";
    ...
    public IMOOCJSONResult add(
        ...
        String shopcartJson = redisOperator.get(carIndex + ":" + userId);
        ...
        // 覆盖现有redis中的购物车
        redisOperator.set(carIndex + ":" + userId, JsonUtils.objectToJson(shopcartList));
